...
import CreatePaiementModal from "../Paiements/CreatePaiementModal"; // le modal contextuel
...
export default function DemandesAllList() {
  ...
  const canPayThisDemande = (d) => {
    // adapte selon tes statuts: ex "approuvee" ou "en_attente_paiement"
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {loading ? (
                ...
                <tr>
                  <td className="px-4 py-4 text-red-600 dark:text-red-400" colSpan={7}>
                    {error}
                  </td>
                </tr>
              ) : filtered.length === 0 ? (
